...
import 'package:flutter_application_1/features/principal/principal_screens/restaurante_detalle_page.dart';
...
class RestaurantesCarrusel extends StatelessWidget {
  ...
  final List<Map<String, dynamic>> restaurantes = [
    ...
    },
    {
      ...
      "precio": "\$\$",
      "descripcion": "Especialidad en patacones rellenos con sabores únicos.",
    },
    {
    ...
    },
    {
      ...
      "precio": "\$\$",
      "descripcion": "Cocina oriental con woks preparados al momento.",
    },
    {
                  ...
                  return GestureDetector(
                    onTap: () {
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (_) =>
                              RestauranteDetallePage(restaurante: r),
                        ),
                      );
                    },
                    child: Padding(
